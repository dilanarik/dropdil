...
directory='/media/disk_g/WbLS-DATA/raw_root/phase8/muon/'
date=sys.argv[1]
...
pd.DataFrame(results).transpose().to_csv('/media/disk_g/WbLS-DATA/csv/phase8/bnl1t_spe_fit_results_'+date+'.csv',index=False)
